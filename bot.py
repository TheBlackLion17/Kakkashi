...
from AgsBot.util.keepalive import ping_server
from AgsBot.Bot.clients import initialize_clients
...
async def Lucy_start():
    ...
    for name in files:
        with open(name) as a:
            ...
            print("Ags Bot Imported => " + plugin_name)
    if ON_HEROKU:
